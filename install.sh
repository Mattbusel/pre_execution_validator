#!/bin/sh
# Install pesvf (pre_execution_validator) from the latest GitHub release.
#
#   curl -fsSL https://raw.githubusercontent.com/Mattbusel/pre_execution_validator/main/install.sh | sh
#
...
# SHA256SUMS.txt, and copies one file (pesvf) into INSTALL_DIR. Nothing else.
set -eu

REPO="Mattbusel/pre_execution_validator"
PREFIX="pre_execution_validator"      # archive name prefix
BIN="pre_execution_validator"            # file name inside the archive
CMD="pesvf"            # command name you will type
