# Install pesvf (pre_execution_validator) on Windows from the latest GitHub release.
#
#   irm https://raw.githubusercontent.com/Mattbusel/pre_execution_validator/main/install.ps1 | iex
#
# It downloads the Windows zip, checks it against the release's SHA256SUMS.txt,
# puts pesvf.exe in %LOCALAPPDATA%\Programs\pesvf and adds that folder to
...
$Prefix = 'pre_execution_validator'
$Bin    = 'pre_execution_validator'
$Cmd    = 'pesvf'
...
Write-Host "Try it: pesvf   (open a new terminal if the command is not found)"
